...
% legend('boxoff');
X =  [100,200,300,300,400];
QX = [1,  1,   1,  0,  0];
RX = [200,100, 0,  0,  0];
MX = [300,300,300,  0,  0];
MXLMP =        [200,200,300,  0,  0];
RX_half =      [100, 50,  0,  0,  0];
MXrelax_half = [200,250,300,0,0];
%%
figure
...
print('-dpng','-r1000','V2_演示性Q_1(X)和M_1(X)的关系_1.png');
...
"0.5-激励相容的收入函数M''(X)",'Location','Southwest')
legend('boxoff')
